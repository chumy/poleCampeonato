                      ...
                      <tbody>
                        <tr>
                          ...
                          <button type="button" rel="tooltip" title="Edit Task" class="btn btn-primary btn-link btn-sm">
                              ...
                              <button type="button" rel="tooltip" title="Añadir Participantes" class="btn btn-primary btn-link btn-sm" 
                              onclick="window.location.href='/admin/campeonato/1/participantes'">
                                <i class="material-icons">person</i>
                              </button>
                              
                              <button type="button" rel="tooltip" title="Resultados" class="btn btn-primary btn-link btn-sm"  onclick="window.location.href='/admin/resultados'">
                                <i class="material-icons">list_alt</i>
                              </button>
                              <button type="button" rel="tooltip" title="Cambiar visibilidad" class="btn btn-primary btn-link btn-sm">
