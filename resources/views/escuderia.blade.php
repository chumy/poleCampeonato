...
@section('content')
  ...
  <div class="container">
      ...
      <div class="col-lg-4">
        ...
        <span class="navbar-brand mb-0 h1"><a href="/campeonato" class=" badge badge-light"><h5>Campeonato 1</h5></a></span>
  ...
  <section class="secciones-portada bg-light text-center" >
    <div class="container">
      <div class="row">
        ...
        <div class="text-right">
           <h4> <span class="badge badge-secondary">Apodo1: 20 puntos</span> </h4>
           <h4> <span class="badge badge-secondary">Apodo2: 15 puntos</span> </h4>
        </div>
